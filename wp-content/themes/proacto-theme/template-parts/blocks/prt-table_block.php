...
$table_block = get_field('table');
$table = $table_block['schedule'];
?>

<section class="<?php echo  esc_attr($className)?> prt-table_block">
    <div class="container-small">
        <div class="table_block__head underlined">
            <h3 class="heading-h2">
			    <?= $table_block['title'] ?>
            </h3>
        </div>
        <div class="table_block__main">
            <?php if(!empty($table_block['subtitle'])): ?>
                <h3 class="table_block__subtitle heading-h4">
            ...
            <?php if (!empty($table_block['add_links']['links'])) : ?>
	            <?php foreach ($table_block['add_links']['links'] as $link): ?>
