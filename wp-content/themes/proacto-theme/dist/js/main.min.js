...
/***/ "./js/blocks/accordeons.js":
/*!*********************************!*\
  !*** ./js/blocks/accordeons.js ***!
  \*********************************/
/***/ (function() {

var accordeons = document.querySelectorAll('.accordeons-card');
...
/***/ "./js/blocks/graduates.js":
/*!********************************!*\
  !*** ./js/blocks/graduates.js ***!
  \********************************/
/***/ (function() {

var gradYears = document.querySelectorAll('.graduates__header .default-dropdown li');
var gradContainer = document.getElementById('graduates_response');
if (gradYears) {
  gradYears.forEach(function (elem) {
    elem.addEventListener('click', function () {
      var id = this.dataset.cat;
      var ajaxurl = gradContainer.dataset.url;
      jQuery.ajax({
        url: ajaxurl,
        type: 'POST',
        data: {
          action: 'filter_grads',
          // The action hook name on the server side
...
if (projectsBlock) {
  var projectsFilterButtons = projectsBlock.querySelectorAll('.projects__header__wrap .choise-chips');
  var projectCards = projectsBlock.querySelectorAll('.projects__list .project-card');
  projectsFilterButtons.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      var dataTarget = button.dataset.target;
      projectsFilterButtons.forEach(function (item) {
...
var news_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.news_slider-wrap.swiper', {
  // Optional parameters
  direction: 'horizontal',
  spaceBetween: 0,
  slidesPerView: 1,
...
var gallery_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.photo_gallery .swiper', {
  // Optional parameters
  direction: 'horizontal',
  spaceBetween: 0,
  slidesPerView: 1,
...
if (document.body.clientWidth < 980) {
  var feed_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.feed_categories__wrap .swiper', {
    // Optional parameters
    direction: 'horizontal',
    spaceBetween: 16,
    slidesPerView: 1,
...
/***/ "./js/blocks/teachers.js":
/*!*******************************!*\
  !*** ./js/blocks/teachers.js ***!
  \*******************************/
/***/ (function() {

var filters = document.querySelectorAll('.teachers__header .default-dropdown__list li');
var teacherCards = document.querySelectorAll('.teacher_card');
if (filters) {
...
/***/ "./js/templates/dropdowns.js":
/*!***********************************!*\
  !*** ./js/templates/dropdowns.js ***!
  \***********************************/
/***/ (function() {

var dropdowns = document.querySelectorAll('.default-dropdown');
dropdowns.forEach(function (dropdown) {
  var trigger = dropdown.querySelector('.default-dropdown__opener');
  trigger.addEventListener('click', function () {
    dropdown.classList.toggle('active');
  });
  var options = dropdown.querySelectorAll('.default-dropdown__list li');
...
var menuAncestros = document.querySelectorAll('.header .menu-item-has-children');
menuAncestros.forEach(function (elem) {
  elem.addEventListener('click', function (e) {
    e.stopPropagation();
    menuAncestros.forEach(function (child) {
      if (child != elem) {
...
/* harmony import */ var _templates_dropdowns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./templates/dropdowns */ "./js/templates/dropdowns.js");
/* harmony import */ var _templates_dropdowns__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_templates_dropdowns__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _blocks_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blocks/slider */ "./js/blocks/slider.js");
/* harmony import */ var _blocks_accordeons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blocks/accordeons */ "./js/blocks/accordeons.js");
/* harmony import */ var _blocks_accordeons__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_blocks_accordeons__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _blocks_teachers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blocks/teachers */ "./js/blocks/teachers.js");
/* harmony import */ var _blocks_teachers__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_blocks_teachers__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _blocks_graduates__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./blocks/graduates */ "./js/blocks/graduates.js");
/* harmony import */ var _blocks_graduates__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_blocks_graduates__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _blocks_projects__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blocks/projects */ "./js/blocks/projects.js");
/* harmony import */ var _blocks_projects__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_blocks_projects__WEBPACK_IMPORTED_MODULE_6__);
